...
class Record < ApplicationRecord
  ...
  private
    ...
    def parse_url(json_hash)
      ...
      return nil if json_hash.dig("portal_urls").first.blank?
    ...
    def send_sva_json_to_server
      ...
      begin
        result = ApiRequestService.new(url, nil, nil, sva_json_data, Authorization: "Bearer #{access_token}").post_request
